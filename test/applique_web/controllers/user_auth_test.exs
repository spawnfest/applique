defmodule AppliqueWeb.UserAuthTest do
  use AppliqueWeb.ConnCase, async: true

  alias Applique.Accounts
  alias AppliqueWeb.UserAuth
  import Applique.AccountsFixtures

  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, AppliqueWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
  ...
  describe "logout_user/1" do
    ...
    test "broadcasts to the given live_socket_id", %{conn: conn} do
      ...
      AppliqueWeb.Endpoint.subscribe(live_socket_id)
