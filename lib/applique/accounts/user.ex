defmodule Applique.Accounts.User do
  use Ecto.Schema
  ...
  schema "users" do
    ...
    field :avatar, Applique.AvatarUploader.Type
  ...
  defp validate_email(changeset) do
    ...
    |> unsafe_validate_unique(:email, Applique.Repo)
  ...
  """
  def valid_password?(%Applique.Accounts.User{hashed_password: hashed_password}, password)
